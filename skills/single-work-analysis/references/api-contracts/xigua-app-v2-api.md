# Xigua-App-V2-API 完整契约

- 回到索引：[`api-capability-index.md`](../api-capability-index.md)
- 回到路由详情：[`api-tags/xigua-app-v2-api.md`](../api-tags/xigua-app-v2-api.md)
- 当前契约文件：`api-contracts/xigua-app-v2-api.md`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| item_id | query | string | 是 | 作品id/Video id | 无 | 7354954305222377999 | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| user_id | query | string | 是 | 用户id/User id | 无 | 52712347586 | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| user_id | query | string | 是 | 用户id/User id | 无 | 1922379661976311 | 无 |
| max_behot_time | query | string | 否 | 最大行为时间/Maximum behavior time | 无 | 无 | 无 |
...
| offset | query | integer | 否 | 偏移量/Offset | 0 | 无 | 无 |
| order_type | query | string | 否 | 排序方式/Order type | 无 | 无 | 无 |
| min_duration | query | integer | 否 | 最小时长/Minimum duration | 无 | 无 | 无 |
| max_duration | query | integer | 否 | 最大时长/Maximum duration | 无 | 无 | 无 |
