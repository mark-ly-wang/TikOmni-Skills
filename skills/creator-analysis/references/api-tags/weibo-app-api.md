...
- 完整契约：[`api-contracts/weibo-app-api.md`](../api-contracts/weibo-app-api.md)
...
- 完整契约：[`api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-ai-smart-search`](../api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-ai-smart-search)
...
- 完整契约：[`api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-home-recommend-feed`](../api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-home-recommend-feed)

#### 参数

| 字段 | 位置 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- | --- |
| page | query | string | 否 | 页码，首页不传，第二页传2 |
| count | query | integer | 否 | 每页数量 |
...
- 完整契约：[`api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-hot-search`](../api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-hot-search)

#### 参数

| 字段 | 位置 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- | --- |
| category | query | string | 否 | 热搜分类: mineband=我的, realtimehot=热搜, social=社会, fun=文娱, technologynav=科技, lifenav=生活, region=同城, sportnav=体育, gamenav=ACG |
| page | query | integer | 否 | 页码 |
| count | query | integer | 否 | 每页数量 |
...
- 完整契约：[`api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-hot-search-categories`](../api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-hot-search-categories)
...
- 完整契约：[`api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-search-all`](../api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-search-all)
...
| query | query | string | 是 | 搜索关键词 |
| page | query | integer | 否 | 页码 |
| search_type | query | integer | 否 | 搜索类型: 1=综合, 61=实时, 3=用户, 64=视频, 63=图片, 62=关注, 60=热门, 21=全网, 38=话题, 98=超话, 92=地点, 97=商品 |
...
- 完整契约：[`api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-status-comments`](../api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-status-comments)

#### 参数

| 字段 | 位置 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- | --- |
| status_id | query | string | 是 | 微博ID |
| max_id | query | string | 否 | 翻页游标 |
| sort_type | query | string | 否 | 排序类型: 0=按热度排序, 1=按时间排序 |
...
- 完整契约：[`api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-status-detail`](../api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-status-detail)
...
- 完整契约：[`api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-status-likes`](../api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-status-likes)
...
| --- | --- | --- | --- | --- |
| status_id | query | string | 是 | 微博ID |
| attitude_type | query | string | 否 | 点赞类型: 0=全部, 1=点赞, 2=开心, 3=惊讶, 4=伤心, 5=愤怒, 6=打赏, 8=抱抱 |
...
- 完整契约：[`api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-status-reposts`](../api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-status-reposts)
...
- 完整契约：[`api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-user-album`](../api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-user-album)

#### 参数

| 字段 | 位置 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- | --- |
| uid | query | string | 是 | 用户ID |
| since_id | query | string | 否 | 翻页游标 |
...
- 完整契约：[`api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-user-articles`](../api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-user-articles)
...
- 完整契约：[`api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-user-audios`](../api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-user-audios)
...
- 完整契约：[`api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-user-info`](../api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-user-info)
...
- 完整契约：[`api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-user-info-detail`](../api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-user-info-detail)
...
- 完整契约：[`api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-user-profile-feed`](../api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-user-profile-feed)
...
- 完整契约：[`api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-user-super-topics`](../api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-user-super-topics)
...
- 完整契约：[`api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-user-timeline`](../api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-user-timeline)
...
| uid | query | string | 是 | 用户ID |
| page | query | integer | 否 | 页码 |
| filter_type | query | string | 否 | 筛选类型 |
| month | query | string | 否 | 时间筛选(YYYYMMDD格式) |
...
- 完整契约：[`api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-user-videos`](../api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-user-videos)
...
- 完整契约：[`api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-video-detail`](../api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-video-detail)

#### 参数

| 字段 | 位置 | 类型 | 必填 | 说明 |
| --- | --- | --- | --- | --- |
| mid | query | string | 是 | 视频微博ID |
...
- 完整契约：[`api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-video-featured-feed`](../api-contracts/weibo-app-api.md#get-api-u1-v1-weibo-app-fetch-video-featured-feed)
