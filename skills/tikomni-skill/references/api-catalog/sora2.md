...
| --- | --- | --- | --- | --- | --- | --- |
| POST | /api/u1/v1/sora2/create_video | [已弃用/Deprecated] 文本/图片生成视频/Create video from text or image | header:authorization, body:prompt | body:orientation, body:media_id | other | Sora2-API |
...
| GET | /api/u1/v1/sora2/get_task_detail | [已弃用/Deprecated] 获取任务生成的作品详情（无水印版本）/Get task-generated post detail (watermark-free) | header:authorization | query:task_id, query:generation_id | single_post | Sora2-API |
| GET | /api/u1/v1/sora2/get_task_status | [已弃用/Deprecated] 查询任务状态/Get task status | header:authorization, query:task_id | - | other | Sora2-API |
