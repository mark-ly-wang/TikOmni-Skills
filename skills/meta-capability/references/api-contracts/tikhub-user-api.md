# TikHub-User-API 完整契约

- 回到索引：[`api-capability-index.md`](../api-capability-index.md)
- 回到路由详情：[`api-tags/tikhub-user-api.md`](../api-tags/tikhub-user-api.md)
- 当前契约文件：`api-contracts/tikhub-user-api.md`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| endpoint | query | string | 是 | 请求的端点/Requested endpoint | 无 | /api/v1/douyin/app/v1/fetch_one_video | 无 |
| request_per_day | query | integer | 否 | 每日请求次数/Request per day | 1 | 100000 | 无 |
...
| code | integer | 否 | HTTP status code \| HTTP状态码 | 200 | 无 | 无 |
| router | string | 否 | The endpoint that generated this response \| 生成此响应的端点 | 无 | 无 | 无 |
| api_key_data | object | 是 | 无 | 无 | 无 | 无 |
| api_key_data.api_key_name | string | 是 | 无 | 无 | 无 | 无 |
| api_key_data.api_key_scopes | array<未声明> | 是 | 无 | 无 | 无 | 无 |
| api_key_data.created_at | string(date-time) | 是 | 无 | 无 | 无 | 无 |
| api_key_data.expires_at | string(date-time) | 是 | 无 | 无 | 无 | 无 |
| api_key_data.api_key_status | integer | 是 | 无 | 无 | 无 | 无 |
| user_data | object | 是 | 无 | 无 | 无 | 无 |
| user_data.email | string | 是 | 无 | 无 | 无 | 无 |
| user_data.balance | number | 是 | 无 | 无 | 无 | 无 |
| user_data.free_credit | number | 是 | 无 | 无 | 无 | 无 |
| user_data.email_verified | boolean | 是 | 无 | 无 | 无 | 无 |
| user_data.account_disabled | boolean | 是 | 无 | 无 | 无 | 无 |
| user_data.is_active | boolean | 是 | 无 | 无 | 无 | 无 |
