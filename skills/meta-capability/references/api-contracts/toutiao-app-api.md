# Toutiao-App-API 完整契约

- 回到索引：[`api-capability-index.md`](../api-capability-index.md)
- 回到路由详情：[`api-tags/toutiao-app-api.md`](../api-tags/toutiao-app-api.md)
- 当前契约文件：`api-contracts/toutiao-app-api.md`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| group_id | query | string | 是 | 作品ID/Post ID | 无 | 7450114952884503059 | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| group_id | query | string | 是 | 作品ID/Post ID | 无 | 7453372680222523931 | 无 |
| offset | query | string | 是 | 偏移量/Offset | 无 | 0 | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| user_profile_url | query | string | 是 | 用户主页链接/User profile URL | 无 | https://www.toutiao.com/c/user/token/MS4wLjABAAAAwK6echNksY69R8l2vcZudupfhTItbG… | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| user_id | query | string | 是 | 用户ID/User ID | 无 | 1352838578180211 | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| group_id | query | string | 是 | 作品ID/Post ID | 无 | 7431543350882206242 | 无 |
