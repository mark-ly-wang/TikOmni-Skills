...
| --- | --- | --- | --- | --- | --- | --- |
| POST | /api/u1/v1/wechat_channels/fetch_comments | 微信视频号评论/WeChat Channels Comments | header:authorization, body:id | body:lastBuffer, body:comment_id | comments | WeChat-Channels-API |
| POST | /api/u1/v1/wechat_channels/fetch_default_search | 微信视频号默认搜索/WeChat Channels Default Search | header:authorization, body:keywords | body:session_buffer | search | WeChat-Channels-API |
| POST | /api/u1/v1/wechat_channels/fetch_home_page | 微信视频号主页/WeChat Channels Home Page | header:authorization, body:username | body:last_buffer | home_posts | WeChat-Channels-API |
