# Xiaohongshu-Web-V2-API 完整契约

- 回到索引：[`api-capability-index.md`](../api-capability-index.md)
- 回到路由详情：[`api-tags/xiaohongshu-web-v2-api.md`](../api-tags/xiaohongshu-web-v2-api.md)
- 当前契约文件：`api-contracts/xiaohongshu-web-v2-api.md`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| note_id | query | string | 是 | 笔记ID/Note ID | 无 | 66c9cc31000000001f03a4bc | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| short_url | query | string | 是 | 短链/Short URL | 无 | http://xhslink.com/a/tyoREa3ciaAeb | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| user_id | query | string | 是 | 用户ID/User ID | 无 | 604a28420000000001005211 | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| user_id | query | string | 是 | 用户ID/User ID | 无 | 5e3a8ee700000000010070c6 | 无 |
| cursor | query | string | 否 | 游标/Cursor | 无 | 无 | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| note_id | query | string | 是 | 笔记ID/Note ID | 无 | 651ccaa9000000001f03d7f7 | 无 |
| cursor | query | string | 否 | 游标/Cursor | 无 | 无 | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| user_id | query | string | 是 | 用户ID/User ID | 无 | 627e35aa00000000210275ae | 无 |
| page | query | string | 否 | 页码/Page number | 1 | 无 | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| keywords | query | string | 是 | 搜索关键词/Search keywords | 无 | 口红 | 无 |
| page | query | integer | 否 | 页码/Page number | 1 | 无 | 无 |
| sort_type | query | string | 否 | 排序方式/Sort type | general | 无 | 无 |
| note_type | query | string | 否 | 笔记类型/Note type | 0 | 无 | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| note_id | query | string | 是 | 笔记ID/Note ID | 无 | 673c894c0000000007033f92 | 无 |
| comment_id | query | string | 是 | 评论ID/Comment ID | 无 | 673ecdfc000000001503bf8b | 无 |
| cursor | query | string | 否 | 游标/Cursor | 无 | 无 | 无 |
