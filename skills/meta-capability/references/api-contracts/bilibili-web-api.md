# Bilibili-Web-API 完整契约

- 回到索引：[`api-capability-index.md`](../api-capability-index.md)
- 回到路由详情：[`api-tags/bilibili-web-api.md`](../api-tags/bilibili-web-api.md)
- 当前契约文件：`api-contracts/bilibili-web-api.md`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| bv_id | query | string | 是 | 作品id/Video id | 无 | BV1M1421t7hT | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| uid | query | string | 是 | 用户UID | 无 | 178360345 | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| pn | query | integer | 否 | 页码/Page number | 1 | 无 | 无 |
...
| bv_id | query | string | 是 | 作品id/Video id | 无 | BV1M1421t7hT | 无 |
| pn | query | integer | 否 | 页码/Page number | 1 | 无 | 无 |
| rpid | query | string | 是 | 回复id/Reply id | 无 | 237109455120 | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| dynamic_id | query | string | 是 | 动态id/Dynamic id | 无 | 1172584638000922630 | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| keyword | query | string | 是 | 搜索关键词/Search keyword | 无 | 火影忍者 | 无 |
| order | query | string | 是 | 排序方式/Order method | 无 | totalrank | 无 |
| page | query | integer | 是 | 页码/Page number | 无 | 1 | 无 |
| page_size | query | integer | 是 | 每页数量/Number per page | 无 | 42 | 无 |
| duration | query | integer | 否 | 时长筛选/Duration filter | 0 | 无 | 无 |
| pubtime_begin_s | query | integer | 否 | 开始日期/Start date (10-digit timestamp) | 0 | 无 | 无 |
| pubtime_end_s | query | integer | 否 | 结束日期/End date (10-digit timestamp) | 0 | 无 | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| share_link | query | string | 是 | 用户分享链接/User share link | 无 | https://b23.tv/1ZuB5NC | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| limit | query | 动态对象 | 是 | 返回数量/Return number | 无 | 10 | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| room_id | query | string | 是 | 直播间ID/Live room ID | 无 | 22816111 | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| area_id | query | string | 是 | 直播分区id/Live area ID | 无 | 9 | 无 |
| pn | query | integer | 否 | 页码/Page number | 1 | 无 | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| room_id | query | string | 是 | 直播间ID/Live room ID | 无 | 1815229528 | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| a_id | query | string | 是 | 作品id/Video id | 无 | 114006081739452 | 无 |
| c_id | query | string | 是 | 作品cid/Video cid | 无 | 28400484458 | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| url | query | string | 是 | 视频链接/Video URL | 无 | https://www.bilibili.com/video/BV1S5uKzzE4r | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| folder_id | query | string | 是 | 收藏夹id/collection folder id | 无 | 1756059545 | 无 |
| pn | query | integer | 否 | 页码/Page number | 1 | 无 | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| uid | query | string | 是 | 用户UID | 无 | 16015678 | 无 |
| offset | query | string | 否 | 开始索引/offset | 无 | 953154282154098691 | 无 |
...
| uid | query | string | 是 | 用户UID | 无 | 178360345 | 无 |
| pn | query | integer | 否 | 页码/Page number | 1 | 无 | 无 |
| order | query | string | 否 | 排序方式/Order method | pubdate | 无 | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| uid | query | string | 是 | 用户UID/User UID | 无 | 178360345 | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| cid | query | string | 是 | 作品cid/Video cid | 无 | 1639235405 | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| aid | query | string | 是 | 作品id/Video id | 无 | 114902186396822 | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| bv_id | query | string | 是 | 作品id/Video id | 无 | BV1vf421i7hV | 无 |
...
| 字段 | 位置 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| bv_id | query | string | 是 | 作品id/Video id | 无 | BV1y7411Q7Eq | 无 |
| cid | query | string | 是 | 作品cid/Video cid | 无 | 171776208 | 无 |
...
| 字段 | 类型 | 必填 | 说明 | 默认值 | 示例 | 枚举 |
| --- | --- | --- | --- | --- | --- | --- |
| bv_id | string | 是 | 作品id/Video id | 无 | BV1y7411Q7Eq | 无 |
| cid | string | 是 | 作品cid/Video cid | 无 | 171776208 | 无 |
| cookie | string | 是 | 大会员用户Cookie/VIP User Cookie | 无 | your_vip_bilibili_cookie | 无 |
